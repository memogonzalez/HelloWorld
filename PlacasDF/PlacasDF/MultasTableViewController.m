...
//#define kWITHOUTDOWN @"2"
//
//@interface MultasTableViewController()
//{
...
//
//@synthesize mb = _mb;
//@synthesize arrMultas = _arrMultas;
//@synthesize numeroMultas = _numeroMultas;
//
//- (id)initWithStyle:(UITableViewStyle)style
//{
...
//    _arrMultas = [[NSArray alloc] initWithArray:( [self getMultasDePlacas:[userDefaults valueForKey:@"Placas"]] )];
//    
//    // pedimos las multas frecuentes
//    arrMultasFrecuentes = [self getMultasFrecuentes];
//}
//
//
//- (NSArray *)getMultasDePlacas:(NSString *)strPlacas
//{
//    // Obtenemos todos los objetos tipo 'Multa' guardados
//    __block NSArray *arrMultas = [CoreDataObjectManager objectsForEntityName:@"Multa"];
//    
//    // Si no hay ni uno, consumir el WS para obtenerlos
//    if ([arrMultas count] == 0) 
//    {
//        // animamos la carga de 
//        _mb = [MBProgressHUD showHUDAddedTo:self.navigationController.view animated:YES];
//        [_mb setLabelText:@"Cargando"];
//        [_mb show:YES];
//        
//        // Creamos la URL del WS a consumir
//        NSURL * url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@", URL, strPlacas]];
//        
//        AsyncFileDownloader *asyncFileDownloader = [[AsyncFileDownloader alloc] initWithURL:url];
...
//                                    waitUntilDone:YES];
//                
//                // Volvemos a hacer un fetch de los datos nuevos en CoreData
//                arrMultas = [CoreDataObjectManager objectsForEntityName:@"Multa"];
//                
//                
//                [_mb hide:YES];    
...
//            else 
//            {
//                // Indicar que exitio un error de conexion
//                connectionError = YES;
//                
//                _arrMultas = [NSArray arrayWithObject:@"Error de conexión"];
//
//                [_mb setLabelText:@"Error"];
//                [_mb hide:YES];
//                
...
//    }
//    else {
//        // Ya hay objetos en CoreData
//        [_mb hide:YES];
//    }
//    
//    return [arrMultas copy];
//}
//
//
//- (void)viewDidUnload
...
//}
//
//// TODO: Una clase que se encargue de administrar los datos descargados
...
//    [self stopLoading];
//    
//// TODO: Forzar el consumo desde el WS
//    [self getMultasDePlacas:[userDefaults valueForKey:@"Placas"]];
//}
//
//
//// Al hacer el pull down, refresca los datos
...
//            cell.motivo.text = @"Hubo un error en la comunicación, vuelve a intentarlo";
//            
//        } else if ([_arrMultas count] > 0) {
//    
//            NSDictionary *multa = [_arrMultas objectAtIndex:[indexPath row]];
//            
//            NSString *imageName = ([[multa valueForKey:@"situacion"] intValue] == 0) ? @"ok.png" : @"nook.png";
//            
//            UIImage *image = [UIImage imageNamed:imageName];
//            
//            // TODO: Convertir date a str
//            // cell.fecha.text = [multa valueForKey:@"fecha_infraccion"];
//    
//            NSLog(@"%@", [multa valueForKey:@"motivo"]);
//            
//            cell.sancion.text = [NSString stringWithFormat:@"%d días de salario mínimo", ( [[multa valueForKey:@"sancion"] intValue])];
//    
//            cell.motivo.text = [self formatString:[multa valueForKey:@"motivo"]];
//    
//            [cell.situacion setImage:image];
//            
//        } else {
...
////        sinPagar = 0;
////        
////        _arrMultas = [multas objectForKey:@"multa"];
////    
////        for (NSDictionary * multa in _arrMultas) {
////        
////            sinPagar = ([[multa objectForKey:@"status"] isEqualToString:@"No pagada"]) ? sinPagar + 1: sinPagar;
////        
////            NSLog(@"%@", [multa objectForKey:@"multa_id"]);        
...
////    } else {
////        
////        _arrMultas = [NSArray arrayWithObject:@"Sin multas"];
////    }
////    
////    if (sinPagar > 0) {
////        
